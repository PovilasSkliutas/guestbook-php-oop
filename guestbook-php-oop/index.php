...
$notfeatured = $review->getNotFeatured();
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <h3 class="mb-0">
                <a class="text-dark" href="#"><?= $one['Email']; ?></a>
              </h3>
              <div class="mb-1 text-muted"><?= $one['Date']; ?></div>
              <p class="card-text mb-auto"><?= substr($one['Review'], 0, 150); ?></p>
            </div>
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <?php foreach ($notfeatured as $one): ?>
          <div class="blog-post">
            <h2 class="blog-post-title"><?= $one['Email']; ?></h2>
